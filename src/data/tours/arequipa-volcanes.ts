export const arequipaVolcanesData = {
  id: 'arequipa-volcanoes',
  category: 'trekking',
  subCategory: 'arequipa',
  es: {
    hero: {
    ...
    intro: {
      ...
      description: "Esta expedición es única en Sudamérica. Descubre la arquitectura Patrimonio de la Humanidad, el cañón más profundo y conquista las cumbres de los volcanes Chachani (6075m) y Misti (5822m).",
      image: "/slider_3.png",
      lat: `16° 23' 55" S`,
      lon: `71° 32' 12" W`,
      specs: [
  ...
  en: {
    ...
    intro: {
      ...
      description: "This expedition is unique in South America. Discover World Heritage architecture, the deepest canyon, and conquer the summits of Chachani (6075m) and Misti (5822m).",
      image: "/slider_3.png",
      lat: `16° 23' 55" S`,
      lon: `71° 32' 12" W`,
      specs: [
